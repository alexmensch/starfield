...
// (Unix-seconds) the planets are positioned for. Lives bottom-left in
// `.ui-bottom`, next to the scale-bar.
//
// Visible only while the focused star has a planet system (3re.6
// contract — Sol in v1) and chart mode is off; matches the rest of the
// solar-system layer's visibility gate.
//
